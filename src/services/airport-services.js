...
async function destroyAirport(id) {
    try {
        ...
        throw new AppError('Something went wrong, Cannot destroy the airport', StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
async function updateAirport(id, data) {
    try {
        ...
        throw new AppError('Something went wrong, Cannot update the Airport', StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
